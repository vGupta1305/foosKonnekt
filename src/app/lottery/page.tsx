  ...
  return (
    <div className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6">
      <div className="mb-6 flex flex-col gap-1">
        <h1 className="text-2xl font-semibold tracking-tight">Allocation Lottery</h1>
        <p className="text-sm text-muted-foreground">
          Allocated players ({MAX_PLAYERS_PER_TIER} total) are drawn by lot
          and assigned one per team, free of charge. The remaining players
          are auctioned normally.
        </p>
      </div>
      <LotteryView
